...
<body id="page-top">
  ...
  <section class="callout">
    <div class="container text-center">
      <h3 class="mx-auto mb-5">Has buscado:<%= request.getAttribute("esp") %>, un plato que encontrarás en un  <%=request.getAttribute("wat_esp") %></h3>
      <h3 class="mx-auto mb-5">You looked for: <%= request.getAttribute("eng") %>. You can find this in <%=request.getAttribute("wat") %> restaurants</h3>
    </div>
  </section>
